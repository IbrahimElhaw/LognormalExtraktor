...
def estimate_theta_SE(x_values, y_values, D, sigma, meu, t0, characteristic_points, i=1):
    ...
    plt.scatter(x_values[xinf1], y_values[xinf1])
    plt.scatter(x_values[x3], y_values[x3])
    plt.scatter(x_values[xinf2], y_values[xinf2])
    plt.show()
...
if __name__ == '__main__':
    x_values, y_values, timestamps_arr, smoothed_velocity, velocity = openfiles.load_input("new_try3.npz")
    # x_values, y_values, timestamps_arr, smoothed_velocity, velocity = draw_movment.get_preprocessed_input()
    # openfiles.save_input(x_values, y_values, timestamps_arr, smoothed_velocity, velocity, filename="new_try3.npz")
